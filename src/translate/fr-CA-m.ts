...
export default {
  ...
  ContactsScreen: {
    ...
    noContactsYet: "Envoyez ou recevez un paiement en utilisant un nom d'utilisateur et il sera automatiquement ajouté à vos contacts ici",
      ...
      },
      {
        content: [
          ...
          },
          {
            ...
            question: "Pourquoi devrais-je me soucier du contrôle du gouvernement sur la monnaie fiduciaire?",
          ...
          },
          {
            ...
            question: "Qu'arrive-t-il à la valeur des monnaies fiduciaires avec le temps?",
            ...
            title: "Est-ce que cela signifie que toutes les monnaies fiduciaires perdent de la valeur avec le temps?",
            type: "Text",
          },
          {
            answers: [
            ...
            title: "D'accord, les monnaies fiduciaires perdent de la valeur avec le temps. Y-a-t-il d'autres problèmes?",
            type: "Text",
          },
        ],
        meta: {
  ...
  Overlay: {
    ...
    rewards: {
      download: "Nous vous avons donné 1 sat comme cadeau\npour télécharger l'application.",
  ...
  SecurityScreen: {
    ...
    biometryNotEnrolled: "SVP enregistrez au moins un senseur biométrique pour utiliser l'authentification biométrique.",
    hideBalanceDescription: "Masquer votre solde sur l'écran d'accueil par défaut pour dissimuler vos informations à quiconque regarderait votre écran.",
  ...
  SendBitcoinConfirmationScreen: {
    ...
    stalePrice: "Votre prix pour un bitcoin est périmé et a été mis-à-jour il y a {{timePeriod}}. Veuillez redémarrer l'application avant d'effectuer un paiement.",
  ...
  SettingsScreen: {
    ...
    csvTransactionsError: "Impossible d'exporter les transactions vers un fichier CSV. Une erreur s'est produite. Si le problème persiste, veuillez contacter le support technique.",
    lnurlNoUsername: "Pour générer une adresse LNURL, vous devez d'abord définir un nom d'usager. Voulez-vous définir un nom d'usager maintenant?",
  ...
  UsernameScreen: {
    ...
    "available": "✅  %{input} est disponible",
    "confirmSubtext": "Le nom d'usager est permanent et ne peut être changé plus tard",
    "confirmTitle": "Définir %{input} comme nom d'usager?",
    "forbiddenStart": "Ne peut débuter par lnbc1, bc1, 1, ou 3 et ne peut pas être une adresse Bitcoin ou une facture Lightning",
    "letterAndNumber": "Lettre minuscule uniquement, chiffre et sousligné (_) sont acceptés",
    "emailAddress": "Le nom d'usager ne peut pas être un courriel",
    "notAvailable": "❌  %{input} n'est pas disponible",
    "success": "%{input} est maintenant votre nom d'usager!",
  ...
  WelcomeFirstScreen: {
    ...
    before: "Avant Bitcoin, les gens dépendaient des banques ou des fournisseurs de cartes de crédit pour dépenser, recevoir et envoyer de l'argent.",
  ...
  WelcomePhoneInputScreen: {
    header: "Entrez votre numéro de téléphone et nous vous enverrons un code d'accès par texto.",
  ...
  WelcomePhoneValidationScreen: {
    ...
    header: "Pour confirmer votre numéro de téléphone, entrez le code que nous venons de vous envoyer au %{phone}",
  ...
  errors: {
    ...
    tooManyRequestsPhoneCode: "Trop de requêtes. Veuillez patienter avant de demander un autre texto.",
    network: {
      server: "Erreur de serveur. SVP essayer plus tard",
      request: "Problème avec une requête.\nContactez le support technique si le problème persiste",
    ...
    fatalError: "Désolé, nous semblons avoir des problèmes pour charger les données de l'application. Si le problème persiste, contactez le support technique.",
