...
export default {
  ...
  ContactsScreen: {
    ...
    noContactsYet: "Envie ou receba um pagamento usando um nome de usuário e os contatos serão adicionados automaticamente aqui",
    noMatchingContacts: "Nenhum contato correspondente à sua pesquisa foi encontrado.",
    title: "Contatos",
  },
  ContactDetailsScreen: {
    title: "Transações com %{input}",
  },
  ...
  ConversionConfirmationScreen: {
    ...
    youreConverting: "Você está convertendo",
    receivingAccount: "Conta de destino"
  },
  ...
  EarnScreen: {
    earnSats: {
      one: "Ganhe 1 sat",
      other: "Ganhe {{formatted_number}} sats",
    },
    earns: [
      {
        content: [
          ...
          },
          {
            ...
            id: "copyBitcoin",
            question: "Se o Bitcoin é dinheiro digital, alguém não pode simplesmente copiá-lo - e criar dinheiro grátis?",
            ...
            title: "Se o Bitcoin é dinheiro digital, alguém não pode simplesmente copiá-lo - e criar dinheiro grátis?",
            type: "Text",
          },
        ],
        meta: {
      ...
      },
      {
        content: [
          ...
          },
          {
            ...
            id: "moneyEvolution",
            question: "Quais são alguns itens que foram historicamente usados como unidade monetária?",
          ...
          },
          {
            ...
            question: "Por que pedras, conchas e ouro foram usados como unidades de dinheiro?",
            ...
            title: "Por que pedras, conchas e ouro eram comumente usados como dinheiro no passado?",
            type: "Text",
          },
          {
            answers: [
          ...
          },
          {
            ...
            question: "Quem pode imprimir legalmente dólares americanos, sempre que desejar?",
        ...
        content: [
          {
            ...
            id: "WhatIsFiat",
            question: "Quem cria moeda fiduciária, como dólares americanos ou francos suíços?",
          ...
          },
          {
            ...
            question: "Por que eu deveria me preocupar com o governo controlando a moeda fiduciária?",
          ...
          },
          {
            ...
            title: "Quem deve se importar que o governo possa imprimir dinheiro ilimitado?",
            type: "Text",
          },
          {
            answers: [
            ...
            question: "O que acontece com o valor de todas as moedas fiduciárias ao longo do tempo?",
            ...
            title: "Isso significa que todo dinheiro fiduciário perde valor ao longo do tempo?",
            type: "Text",
          },
          {
            answers: [
            ...
            id: "OtherIssues",
            question: "Quais são alguns outros problemas que existem com dinheiro fiduciário?",
            ...
            title: "OK, dinheiro fiduciário perde valor com o tempo. Existem outros problemas?",
            type: "Text",
          },
        ],
        meta: {
      ...
      },
      {
        content: [
          ...
          },
          {
            ...
            id: "HighlyDivisible",
            question: "Qual é a menor quantidade de Bitcoin que alguém pode possuir ou usar?",
    ...
    satsEarned: {
      one: "1 sat ganho",
      other: "{{formatted_number}} sats ganhos",
    },
  ...
  ReceiveBitcoinScreen: {
    activateNotifications: "Deseja ativar as notificações para ser notificado quando o pagamento chegar?",
    ...
    tapQrCodeCopy: "Toque em Código QR para copiar",
    ...
    addAmount: "Solicitar Quantia Específica",
    expired: "A fatura expirou",
    expiresIn: "Expira em",
  },
  ...
  SecurityScreen: {
    ...
    pinDescription: "PIN é usado como método de autenticação de backup para autenticação biométrica.",
  ...
  SendBitcoinConfirmationScreen: {
    ...
    maxFeeSelected: "Esta é a taxa máxima que será cobrada por esta transação. Pode acabar sendo menor depois que o pagamento for feito.",
  ...
  SendBitcoinScreen: {
    ...
    cost: "Custo",
    destination: "Destino",
    destinationIsRequired: "O destino é obrigatório",
    fee: "Taxa da rede",
  ...
  SettingsScreen: {
    ...
    title: "Configurações",
    csvTransactionsError: "Não foi possível exportar transações para csv. Algo deu errado. Se o problema persistir, entre em contato com o suporte.",
    lnurlNoUsername: "Para gerar um endereço lnurl você deve primeiro definir um nome de usuário. Deseja definir um nome de usuário agora?",
  ...
  UsernameScreen: {
    ...
    "disponível": "✅ %{input} está disponível",
    "confirmSubtext": "O nome de usuário é permanente e não pode ser alterado posteriormente",
    "confirmTitle": "Definir %{input} como seu nome de usuário?",
    "forbiddenStart": "Não pode começar com lnbc1, bc1, 1 ou 3 e não pode ser um endereço Bitcoin ou fatura Lightning",
    ...
    "notAvailable": "❌ %{input} não está disponível",
    "success": "%{input} agora é seu nome de usuário!",
  ...
  WelcomeFirstScreen: {
    ...
    before: "Antes do Bitcoin, as pessoas dependiam de bancos ou provedores de cartão de crédito para gastar, enviar e receber dinheiro.",
  ...
  WelcomePhoneInputScreen: {
    header: "Digite seu número de telefone e enviaremos um código de acesso por mensagem de texto.",
  ...
  WelcomePhoneValidationScreen: {
    ...
    header: "Para confirmar seu número de telefone, digite o código que acabamos de enviar para você em %{phone}",
  ...
  common: {
    ...
    shareLightning: "Compartilhar fatura Lightning",
    soon: "Em breve!",
    success: "Sucesso!",
    to: "Para",
    Total: "Total",
  ...
  errors: {
    ...
    tooManyRequestsPhoneCode: "Muitas solicitações. Aguarde antes de solicitar outra mensagem de texto.",
    network: {
      server: "Erro no servidor. Tente novamente mais tarde",
      request: "Solicite problema.\nEntre em contato com o suporte se o problema persistir",
    ...
    fatalError: "Desculpe, parece que estamos tendo problemas para carregar os dados do aplicativo. Se os problemas persistirem, entre em contato com o suporte.",
