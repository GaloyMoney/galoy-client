...
export default {
  ...
  ContactsScreen: {
    ...
    noContactsYet: "Envíe o reciba un pago utilizando un nombre de usuario y los contactos se agregarán automáticamente aquí",
  ...
  EarnScreen: {
    earnSats: {
      one: "Gana 1 Satoshi",
      other: "Gana ‪{{formatted_number}}‬ Satoshis",
    },
    earns: [
      {
        content: [
          ...
          },
          {
            ...
            id: "copyBitcoin",
            question: "¿Si Bitcoin es dinero digital, puede alguien solo copiar y crear dinero gratis?",
            ...
            title: "¿Si Bitcoin es dinero digital, puede alguien solo copiar y crear dinero gratis?",
            type: "Text",
          },
        ],
        meta: {
      ...
      },
      {
        content: [
          ...
          },
          {
            ...
            title: "El dinero resuelve la “coincidencia de lo que se quiere o desea” ... ¿¿Qué es eso??",
            type: "Text",
          },
          {
            answers: [
          ...
          },
          {
            ...
            question: "¿Por qué fueron usadas piedras, conchas y oro usadas comúnmente como unidades de dinero?",
            ...
            title: "¿Por qué fueron usadas piedras, conchas y oro usadas comúnmente como dinero en el pasado?",
            type: "Text",
          },
          {
            answers: [
            ...
            id: "moneyIsImportant",
            question: "¿Cuál es la razón principal para que el dinero sea tan importante?",
          ...
          },
          {
            ...
            question: "¿Quién puede imprimir legalmente Dolarea americanas, cada vez que quiera?",
        ...
        content: [
          {
            ...
            id: "WhatIsFiat",
            question: "¿Quién crea la moneda fiar, como el Dólar estadounidense o el Franco Suizo?",
          ...
          },
          {
            ...
            question: "¿Debería preocuparme por que el gobierno controle el dinero impreso (Fiat)?",
          ...
          },
          {
            ...
            title: "¿Debería preocupare por que el gobierno puede imprimir dinero ilimitadamente?",
            type: "Text",
          },
          {
            answers: [
            ...
            question: "¿Qué pasa con el valor del dinero impreso (Fiat) a través del tiempo?",
            ...
            title: "¿Quiere decir que todas las monedas impresas (Fiat) pierden su valor a lo largo del tiempo?",
            type: "Text",
          },
        ],
        meta: {
      ...
      },
      {
        content: [
          ...
          },
          {
            ...
            id: "HighlyDivisible",
            question: "¿Cuál es la menor cantidad de Bitcoin que alguien pueda tener o usar?",
    ...
    satsEarned: {
      one: "1 Satoshi ganado",
      other: "‪{{formatted_number}}‬ Satoshis ganados",
    },
  ...
  ReceiveBitcoinScreen: {
    activateNotifications: "¿Quieres activar notificaciones para que te avisen cuando haya llegado el pago?",
  ...
  SecurityScreen: {
    ...
    hideBalanceDescription: "Ocultar su saldo de forma predeterminada para no mostrarlo si alguien está viendo su pantalla.",
  ...
  SendBitcoinScreen: {
    ...
    noAmount: "Esta factura no tiene un monto, por lo que debe especificar manualmente cuánto dinero desea enviar",
    notConfirmed: "El pago ha sido enviado.\npero aún no está confirmado\n\nPuedes comprobar el estado\ndel pago en Transacciones",
    note: "Nota ",
  ...
  WelcomePhoneValidationScreen: {
    ...
    header: "Para confirmar su cuenta, ingrese el código que le acabamos de enviar al teléfono %{phone}",
  ...
  common: {
    ...
    soon: "Próximamente",
    SSL: "Su información está encriptada y transmitida de forma segura usando SSL",
  ...
  errors: {
    ...
    tooManyRequestsPhoneCode: "Demasiadas peticiones. Por favor, espere antes de solicitar otro mensaje de texto.",
    network: {
      server: "Hubo un error en el servidor.\nPor favor intente más tarde",
      connection: "Error al conectar.\nVerifique su conexión a internet.",
      request: "Hay un error en el requerimiento. Póngase en contacto con el soporte técnico si este problema persiste.",
    },
